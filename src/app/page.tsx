      ...
      <section className="py-16 bg-black">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter">
            Na <span className="text-[#E50914]">REDFLIX</span>, você tem acesso a:
          </h2>
        </motion.div>

        <div className="space-y-4">
          <ContentCarousel title={<>Jogos ao vivo e <span className="text-[#E50914]">MUITO MAIS</span>:</>} items={sportsItems} delay={0} />
          <ContentCarousel title={<>Principais <span className="text-[#E50914]">FILMES</span>:</>} items={moviesItems} delay={2} />
          <ContentCarousel title={<>Melhores <span className="text-[#E50914]">SÉRIES</span>:</>} items={seriesItems} delay={4} />
        </div>
      </section>
